...
--
-- Table structure for table `pduct1`
--
...
(105, 'SKY Accordion 7 Button 2 Bass Music Instrument Accordian(Antique Brown)','Accordian', 62200.00, './assets/pd/1_5.jpg'),
...
(201, 'Kadence INT-38C Acoustic Guitar(Dark Brown)','Acoustic Guitar', 5100.00, './assets/pd/2_1.jpg'),
(202, 'Intern INT-48B Acoustic Guitar(Antique Brown)','Acoustic Guitar', 6000.00, './assets/pd/2_2.jpg'),
(203, 'Kadence WX99 Acoustic Guitar(Glossy Red)','Acoustic Guitar', 6500.00, './assets/pd/2_3.jpg'),
(204, 'Medellin TED Acoustic Guitar(Light Brown)','Acoustic Guitar', 5000.00, './assets/pd/2_4.jpg'),
(205, 'Kadence GL101R Acoustic Guitar(Red and Black)','Acoustic Guitar', 6000.00, './assets/pd/2_5.jpg'),
(206, 'Kadence KL201Z Acoustic Guitar(Orange)','Acoustic Guitar', 8000.00, './assets/pd/2_6.jpg'),
(207, 'Casio ZX100R Acoustic Guitar(Black)','Acoustic Guitar', 10000.00, './assets/pd/2_7.jpg'),
(208, 'Casio AX500D Acoustic Guitar(Royal Blue)','Acoustic Guitar', 7000.00, './assets/pd/2_8.jpg'),
(209, 'YAMAHA QW898RX Acoustic Guitar(Ash Wood)','Acoustic Guitar', 9000.00, './assets/pd/2_9.jpg'),
(210, 'YAMAHA RX100 Acoustic Guitar(Matt Green)','Acoustic Guitar', 9500.00, './assets/pd/2_10.jpg'),
...
(401, 'Pearl A10 Drum Kit(Black)','Drum Kit', 14800.00, './assets/pd/4_1.jpg'),
(402, 'Premier W90 Drum Kit(Raven Black)','Drum Kit', 15200.00, './assets/pd/4_2.jpg'),
(403, 'Tornado 90AX Drum Kit(Red)','Drum Kit', 16000.00, './assets/pd/4_3.jpg'),
(404, 'SlapKlatz 900Z Drum Kit(Blue)','Drum Kit', 17000.00, './assets/pd/4_4.jpg'),
(405, 'Pearl A20 Drum Kit(Purple)','Drum Kit', 15000.00, './assets/pd/4_5.jpg'),

(501, 'Gibson DF900Z Electric Guitar(Blackish Brown)','Electric Guitar', 15000.00, './assets/pd/5_1.jpg'),
(502, 'Gibson R9Z Electric Guitar(Black)','Electric Guitar', 15000.00, './assets/pd/5_2.jpg'),
(503, 'Casio BP98 Electric Guitar(White)','Electric Guitar', 1000.00, './assets/pd/5_3.jpg'),
(504, 'Casio  NS500 Electric Guitar(Raven Black)','Electric Guitar', 8000.00, './assets/pd/5_4.jpg'),
(505, 'Hohner Z300 Electric Guitar(Grey)','Electric Guitar', 9000.00, './assets/pd/5_5.jpg'),
(506, 'Hohner 980S Electric Guitar(Blue)','Electric Guitar', 6000.00, './assets/pd/5_6.jpg'),
(507, 'Medellin 800A Electric Guitar(Wodden Brown)','Electric Guitar', 7500.00, './assets/pd/5_7.jpg'),
(508, 'Medellin 900L Electric Guitar(Blue)','Electric Guitar', 14000.00, './assets/pd/5_8.jpg'),
(509, 'Premier N8P Electric Guitar(Royal Blue)','Electric Guitar', 11000.00, './assets/pd/5_9.jpg'),
(510, 'YAMAHA GIX89 Electric Guitar(Green)','Electric Guitar', 15500.00, './assets/pd/5_10.jpg'),
...
(901, 'Casio 888 Tabla Set(Gold)','Tabla Set', 7500.00,'./assets/pd/9_1.jpg'),
(902, 'Hohner 222 Tabla Set(Bronze)','Tabla Set', 5200.00,'./assets/pd/9_2.jpg'),
(903, 'YAMAHA 111 Tabla Set(Antique Brown)','Tabla Set', 8000.00,'./assets/pd/9_3.jpg'),
(904, 'Medellin 999 Tabla Set(Goldish Brown)','Tabla Set', 4000.00,'./assets/pd/9_4.jpg'),
(905, 'Premier 666 Tabla Set(Brown)','Tabla Set', 9000.00,'./assets/pd/9_5.jpg'),
